...
const Year = React.forwardRef(
    (props: FullYearProps, ref: React.ForwardedRef<HTMLDivElement>) => {
        const overlayButton = useRef(null);
        const sortedSemesters = useMemo(() => {
            return props.semesters.sort(
                (a: SemesterProps, b: SemesterProps) => {
        ...
        return (
            <Container className="container-sm" ref={ref}>
                <Col>
                    ...
                    >
                        <Row>
                            {sortedSemesters.map((props: SemesterProps) => {
                                return (
