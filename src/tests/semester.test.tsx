...
describe(Semester, () => {
    ...
    it("Displays the total number of credits between all courses in the semester", async () => {
        ...
        courses.push({uuid: uuid(), id: "CISC124", name: "test2", prereqs: [], coreqs: [], description: "testing", semester: semesterUuid, credits: 4 });
        courses.push({uuid: uuid(), id: "CISC125", name: "test3", prereqs: [], coreqs: [], description: "testing", semester: semesterUuid, credits: 0 });
    ...
    it("Opens an AddCourse modal when the edit course button is clicked", async () => {
        const testCourses = [{uuid: uuid(), semester: semesterUuid, id: "CISC111", name: "Intro to testing", description: "We really need this", credits: 3, coreqs: [], prereqs: []}];
        render(<Semester
            uuid={semesterUuid}
            courses={testCourses}
            removeSemester={doNothing}
