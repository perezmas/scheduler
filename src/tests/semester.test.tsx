...
describe(Semester,() => {
    ...
    it("Calls the function to clear all courses when the clear button is clicked.", async () => {
        ...
        courses.set(uuid(), {semester: semesterUuid, id: "CISC123", coreqs: [], prereqs: [], name: "intro to whatever", description: "", credits: 0 });
        courses.set(uuid(), {semester: semesterUuid, id: "CISC124", coreqs: [], prereqs: [], name: "Revenge of whatever", description: "", credits: 0 });
